								...
								<div>
									...
									<div class="widget-body no-padding">
										<form class="form-horizontal" action="${rootUrl }self/doCompleteOrder.do" method="post" onsubmit="return check();">
											...
											<input type="hidden" name="desktopName" value="<%=desktop.getName() %>" />
											<fieldset>
												<legend>订单信息</legend>
												...
												<div class="form-group">
													<label class="col-md-2 control-label">桌面</label>
													<div class="col-md-10">
														<input class="form-control" placeholder="Default Text Field" type="text" disabled="disabled" value="<%=desktop.getName() %>">
													</div>
												</div>
