		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div class="row">
					...
					<div id="myTable" class="jarviswidget jarviswidget-color-blueDark" class="jarviswidget jarviswidget-color-blueDark" data-widget-editbutton="false" data-widget-deletebutton="false">
						<!-- widget options:
