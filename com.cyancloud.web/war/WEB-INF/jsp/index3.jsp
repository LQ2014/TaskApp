								...
								<div>
									...
									<div class="widget-body no-padding">
										<div class="panel-group smart-accordion-default" id="accordion-2">
											<c:forEach items="${listNotice }" var="notice" varStatus="items"> 
											<div class="panel panel-default">
												<div class="panel-heading">
													<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseThree-${notice.id }" <c:if test="${items.count>1 }">class="collapsed"</c:if> > <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> ${notice.title } </a></h4>
												</div>
												<div id="collapseThree-${notice.id }" class="panel-collapse collapse <c:if test='${items.count==1}'>in</c:if>">
