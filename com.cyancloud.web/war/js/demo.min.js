...
function() {
	$(this).prop("checked") ? (localStorage.setItem("sm-setmenu", "top")) : (localStorage.setItem("sm-setmenu", "left"));
	var top = 'menu-on-left1';
