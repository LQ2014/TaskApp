...
<%@ page import="com.cyancloud.service.model.DesktopGroupBean"%>
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
<% 
String path="report/listDeskGroup";
%>
	...
	<body id="myBody" onload="onload();">
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div class="row">
					<div hidden=true><reportName>桌面组</reportName></div>
					<!-- NEW WIDGET START -->
							...
							<div>
								...
								<div class="widget-body no-padding">
									...
									<table id="datatable_tabletools"
										...
										<tbody>
										<c:forEach items="${deskGroupList }" var="dg" varStatus="list">
											<tr>
												<td>
													${list.count}
												</td>
