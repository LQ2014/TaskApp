...
<html lang="en-us">
	...
	<body>
		<form id="eidtConfigForm"  name="eidtConfigForm" class="form-horizontal" action="${rootUrl }acl/doEditConfig.do"  method="post" >
			<fieldset>
				<input name="authenticity_token" type="hidden">
				<div class="row">
					<label class="col-md-2 control-label">参数名</label>
					<input type="hidden" id="id" name="id" value="${config.id }" />
					<input type="hidden" id="isEdit" name="isEdit" value="${config.isEdit }" />
					<div class="col-md-10">
						<input class="form-control required" readonly="readonly" type="text" name="key" id="key" value="${config.key }">
					</div>
				</div>				
				<div class="row">
					<label class="col-md-2 control-label">参数值</label>
					<div class="col-md-10">
						<input class="form-control required" type="text" name="value" id="value" value="${config.value }">
					</div>
				</div>			
				<div class="row">
					<label class="col-md-2 control-label">描述</label>
					<div class="col-md-10">
						<input class="form-control" type="text" name="desc" id="desc" value="${config.desc }" >
					</div>
				</div>		
				<div class="row">
					<label class="col-md-2 control-label">备注</label>
					<div class="col-md-10">
						<textarea rows="4" name="note" id="note" class="form-control">${config.note }</textarea>
					</div>
				</div>			
			</fieldset>
		</form>
