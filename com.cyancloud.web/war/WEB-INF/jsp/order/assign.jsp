...
<%
	List<Desktop> desktopList = (List<Desktop>)request.getAttribute("desktopList");
...
<html lang="en-us">
		<script type="text/javascript" language="javascript">
			...
			function check() {
				...
				if(confirm("您是否确认选择桌面"+desktopName+"？")) {
					flag = true;
				}
				return flag;
			}
									...
									<div class="widget-body no-padding">
										<form class="form-horizontal" action="${rootUrl }self/doCompleteOrder.do" method="post" onsubmit="return check();">
											...
											<fieldset>
												...
												<div class="form-group">
													<label class="col-md-2 control-label">选择桌面</label>
													<div class="col-md-10">
														<select class="form-control" name="desktopName" id="desktopName">
															<%
															for(Desktop d:desktopList){
																%>
