...
<%@ page import="com.cyancloud.model.vm.VHost"%>
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
<% 
String path="report/listHost";
%>
<jsp:include page="/WEB-INF/jsp/include.jsp">
	<jsp:param name="page" value="<%=path %>" />
</jsp:include>
<%
	List<VHost> vmHostList = (List<VHost>)request.getAttribute("vmHostList");
%>
<!DOCTYPE html>
<html lang="en-us">
	<body id="myBody" onload="onload();">
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div class="row">
					<div hidden=true><reportName>物理机</reportName></div>
					<!-- NEW WIDGET START -->
							...
							<div>
								...
								<div class="widget-body no-padding">
									...
									<table id="datatable_tabletools"
										...
										<tbody>
										<%for(int i =0;vmHostList!=null && i<vmHostList.size();i++){
											VHost vHost = vmHostList.get(i);
										%>
											<tr>
												<td>
													<%=i+1 %>
