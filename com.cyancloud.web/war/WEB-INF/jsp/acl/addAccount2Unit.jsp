...
<html lang="en-us">
									...
									<table id="datatable_tabletools1" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox">
											...
											<tr>
												<th>
													<label class="checkbox">
														<input id="checkboxall" type="checkbox" name="checkbox-inline" onclick="checkBoxAll(this)">
														<i></i>
													</label>
												</th>
												<th>
										...
										<c:forEach items="${listAccount }" var="account" varStatus="list">
											<tr>
												<td >
													<label class="checkbox">
														<input type="checkbox" name="checkbox" value="${account.id}">
														<i></i>
													</label>
												</td>
	...
	$(document).ready(function() {
		...
		function addAccount(){
			...
			var accountIds = getAllCheckBoxVal();
			if(accountIds && accountIds.length>0){
				$.ajax({
					url : '${rootUrl}acl/doAddAcount2Unit.do',
					dataType : 'json',
					data : {unitId : '${unit.id}', accountIds : accountIds},
					beforeSend:function(){				           		
