...
<script type="text/javascript">
	...
	function confirmDel(orderId){
  		$("#confirm-message").html("<h3>您确认撤销吗？<h3>")  ;
		$("#confirm").dialog("open");
		$("#confirm").dialog({url:"${rootUrl}self/deleteOrder.do?orderId="+orderId});
 	}
						...
						<div>
							...
							<div class="widget-body no-padding">
								...
								<table id="datatable_col_reorder"
									class="table table-striped table-bordered table-hover" style="table-layout:fixed; word-break:keep-all">
									...
									%>
										<tr>
											...
											<td>
												...
												<%if(order.getState()<2){
									%>
												<button class="btn bg-color-yellow txt-color-white" onclick="confirmDel(<%=order.getId()%>)">撤销</button>&nbsp;
													<%}%>
