...
<jsp:include page="/WEB-INF/jsp/include.jsp">
	<jsp:param name="page" value="host"/>
</jsp:include>
<!DOCTYPE html>
<html lang="en-us">
	<body id="myBody" onload="onload();">
		...
		<script src="${rootUrl}js/plugin/flot/jquery.flot.fillbetween.min.js"></script>
		<script src="${rootUrl}js/plugin/flot/jquery.flot.orderBar.min.js"></script>
		<script src="${rootUrl}js/plugin/flot/jquery.flot.pie.min.js"></script>
