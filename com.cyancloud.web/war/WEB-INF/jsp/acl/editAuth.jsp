...
<html lang="en-us">
	<head>
        ...
        function selectParent(e) {
            ...
            win.set({
                expandOnLoad: true,           
                url: "${rootUrl}acl/listAuthTree.do?myId="+myId ,   
                title: "选择权限",
                width: 350,
                height: 250
            });
	...
	<body>
			<form id="myForm"  name="myForm" class="form-horizontal" action="${rootUrl }acl/doEditAuth.do"  method="post" >
				<fieldset>
					<input type="hidden" id="id" name="id" value="${right.id }">
					<input type="hidden" id="parentId" name="parentId" value="${right.parentId }">
					<input type="hidden" id="list" name="list" value="${right.list }">
					<div class="form-group">
							<label class="col-md-2 control-label">名称</label>
							<div class="col-md-10">
								<input class="form-control" type="text" name="name" id="name" value="${right.name }">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<input class="form-control" type="text" name="css" id="css" value="${right.css }">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<input class="form-control" type="text" name="type" id="type" onChange="typeVerify(this)" value="${right.type }">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<input class="form-control" type="text" name="code" id="code" value="${right.code }">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<input id="selParentId" class="mini-buttonedit" onbuttonclick="selectParent" text="<%=parentName%>"/> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<input class="form-control" type="area" name="remark" id="remark" value="${right.remark }">
								<div class="checkbox">
									<label>
										<c:if test="${right.isMenu==true}">
											<input type="checkbox" name="isMenu" id="isMenu" checked=true>功能菜单
										</c:if>
										<c:if test="${empty right.isMenu or right.isMenu==false}">
											<input type="checkbox" name="isMenu" id="isMenu">功能菜单
										</c:if>
