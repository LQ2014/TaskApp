...
<%@ page import="com.cyancloud.service.model.DesktopDelayBean"%>
...
<%
	...
	DesktopDelayBean bean = (DesktopDelayBean)request.getAttribute("detail");
	...
	<body onload="onload();">
    		<div>
    			<fieldset>
					...
					<div>
						<label>续期期限：</label><%=life%>
					</div>
					<div>
						<label>延期原因：</label><%=bean.getReason()%>
					</div>
				</fieldset>
    		</div>
